...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '科技公司',   0, '超级管理员', '15888888888', 'admin@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(101,  100, '0,100',      '成都总公司', 1, '超级管理员', '15888888888', 'admin@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(102,  100, '0,100',      '贵州分公司', 2, '超级管理员', '15888888888', 'admin@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(103,  101, '0,100,101',  '研发部门',   1, '超级管理员', '15888888888', 'admin@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(104,  101, '0,100,101',  '市场部门',   2, '超级管理员', '15888888888', 'admin@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(105,  101, '0,100,101',  '测试部门',   3, '超级管理员', '15888888888', 'admin@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(106,  101, '0,100,101',  '财务部门',   4, '超级管理员', '15888888888', 'admin@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(107,  101, '0,100,101',  '运维部门',   5, '超级管理员', '15888888888', 'admin@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(108,  102, '0,100,102',  '市场部门',   1, '超级管理员', '15888888888', 'admin@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(109,  102, '0,100,102',  '财务部门',   2, '超级管理员', '15888888888', 'admin@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '超级管理员', '00', 'admin@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '管理员');
insert into sys_user values(2,  105, 'ceshi',    '超级管理员', '00', 'admin@qq.com',  '15666666666', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '0', '127.0.0.1', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '测试员');
...
-- 代码生成按钮
insert into sys_menu values('1056', '生成查询', '114', '1', '#',  'F', '0', 'tool:gen:list',  '#', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '');
insert into sys_menu values('1057', '生成代码', '114', '2', '#',  'F', '0', 'tool:gen:code',  '#', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '');
...
insert into sys_job values(1, 'adminTask', '系统默认（无参）', 'adminNoParams',  '',   '0/10 * * * * ?', '3', '1', '1', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '');
insert into sys_job values(2, 'adminTask', '系统默认（有参）', 'adminParams',    'admin', '0/20 * * * * ?', '3', '1', '1', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：2018-07-01 新版本发布啦', '2', '新版本内容', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '管理员');
insert into sys_notice values('2', '维护通知：2018-07-01 系统凌晨维护', '1', '维护内容',   '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '管理员');